...
#ifndef CARRIERCONQUEST_UTIL_EXCEPTIONS_STOPEXCEPTION_H_
#define CARRIERCONQUEST_UTIL_EXCEPTIONS_STOPEXCEPTION_H_

#include <atomic>

namespace carrier_conquest::util::exceptions {
class StopException final {};
}  // namespace carrier_conquest::util::exceptions

#endif  // CARRIERCONQUEST_UTIL_EXCEPTIONS_STOPEXCEPTION_H_
